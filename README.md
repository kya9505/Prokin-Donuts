...
<div align="center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #282d33;">
        <p>Prokin' Donut의 창고 관리 시스템은 효율적이고 정확한 재고 관리를 통해 도넛 가게 운영의 자동화를 목표로 합니다.</p>
        <p>이 시스템은 소매점의 발주와 창고의 재고 현황을 실시간으로 관리하여, 도넛의 품질과 재고 부족을 방지하며, 운영 비용을 절감할 수 있도록 돕습니다.</p>
    </div>
</div>
...
<div align="center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #282d33;">
        🍩 재고 관리 - 도넛 추가, 수정, 삭제, 조회<br>
        📦 소매점 발주 - 발주 요청 & 자동 재고 조정<br>
        👀 재고 현황 조회 - 창고 & 소매점 재고 확인<br>
        🧑‍💻 회원 관리 - 회원 등록, 수정, 삭제, 조회<br>
        🔑 로그인 기능 - 사용자 로그인/로그아웃<br>
        ❌ 시스템 종료
    </div>
</div>
